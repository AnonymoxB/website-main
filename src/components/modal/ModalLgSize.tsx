...
function ModalLgSize({ children, onClose, onSubmit, modalTitle, footer, visible, className, contentClassName, headerClassName, footerClassName }: ModalComponentProps) {
    if (!visible) return
    return (
        <>
            <div
            ...
            >
                <div className="relative lg:min-w-[1000px] my-6 mx-auto max-w-3xl">
                    {/*content*/}
